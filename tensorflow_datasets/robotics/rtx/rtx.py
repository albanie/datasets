...
class BridgeDataMsr(dataset_importer_builder.DatasetImporterBuilder):
  ...
  def get_description(self):
    return r"""A set of object manipulation trajectories collected at Microsoft Research on a WidowX-250 robot in a setup and format compatible with UC Berkeley's BridgeData V2 (https://rail-berkeley.github.io/bridgedata/)"""
  ...
  def get_homepage(self):
    return (
        r"""https://www.microsoft.com/en-us/download/details.aspx?id=105937"""
    )
